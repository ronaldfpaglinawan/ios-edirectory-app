...
class fireDeptViewController: UIViewController, CLLocationManagerDelegate, UIActionSheetDelegate
{
    ...
    @IBAction func call(sender: AnyObject)
    {
        ...
        case "Manila":
            ...
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6325273653")!)
            
            
        case "Quezon City":
            print("current city: Quezon City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6329288363")!)
            
            
        case "Caloocan City":
            print("current city: Caloocan City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6323106527")!)
            
            
        case "Las Piñas City":
            print("current city: Las Piñas City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328730611")!)
            
            
        case "Makati City":
            print("current city: Makati City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328164014")!)
            
            
        case "Malabon City":
            print("current city: Malabon City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6323619712")!)
            
            
        case "Mandaluyong City":
            print("current city: Mandaluyong City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6325322189")!)
            
            
        case "Marikina City":
            print("current city: Marikina City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6326810233")!)
            
            
        case "Muntinlupa City":
            print("current city: Muntinlupa City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328422201")!)
            
            
        case "Navotas City":
            print("current city: Navotas City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6322810854")!)
            
            
        case "Parañaque City":
            print("current city: Parañaque City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328269131")!)
            
            
        case "Pasay City":
            print("current city: Pasay City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328442120")!)
            
            
        case "Pasig City":
            print("current city: Pasig City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6326412815")!)
            
            
        case "Pateros City":
            print("current city: Pateros City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6326411365")!)
            
            
        case "San Juan City":
            print("current city: San Juan City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6327252079")!)
            
            
        case "Taguig City":
            print("current city: Taguig City")
            print("calling the Fire Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328374496")!)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?)
    {
        ...
        if segue.identifier == "FireDeptToSettingsSegue"
        {
