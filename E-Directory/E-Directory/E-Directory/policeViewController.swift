...
class policeViewController: UIViewController, CLLocationManagerDelegate, UIActionSheetDelegate
{
    ...
    @IBAction func call(sender: AnyObject)
    {
        ...
        case "Manila":
            ...
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6322253093")!)
            
            
        case "Quezon City":
            print("current city: Quezon City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6329241025")!)
            
            
        case "Caloocan City":
            print("current city: Caloocan City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6323869363")!)
            
            
        case "Las Piñas City":
            print("current city: Las Piñas City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328718221")!)
            
            
        case "Makati City":
            print("current city: Makati City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328450135")!)
            
            
        case "Malabon City":
            print("current city: Malabon City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6322811133")!)
            
            
        case "Mandaluyong City":
            print("current city: Mandaluyong City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6322322318")!)
            
            
        case "Marikina City":
            print("current city: Marikina City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6326466151")!)
            
            
        case "Muntinlupa City":
            print("current city: Muntinlupa City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328622611")!)
            
            
        case "Navotas City":
            print("current city: Navotas City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6322819099")!)
            
            
        case "Parañaque City":
            print("current city: Parañaque City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328262877")!)
            
            
        case "Pasay City":
            print("current city: Pasay City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6328317322")!)
            
            
        case "Pasig City":
            print("current city: Pasig City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6326411433")!)
            
            
        case "Pateros City":
            print("current city: Pateros City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6326428235")!)
            
            
        case "San Juan City":
            print("current city: San Juan City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6327442480")!)
            
            
        case "Taguig City":
            print("current city: Taguig City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6326423582")!)
            
            
        case "Valenzuela City":
            print("current city: Valenzuela City")
            print("calling the Police Station")
            UIApplication.sharedApplication().openURL(NSURL(string: "tel://+6322940656")!)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?)
    {
        ...
        if segue.identifier == "PoliceToSettingsSegue"
        {
